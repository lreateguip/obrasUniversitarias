...
public class Ekardex {
    ...
    protected ArrayList <DetalleEgresoProducto> listaegre;
    protected String estado;

    public Ekardex() {
    }

    public Ekardex(int id, String numreq, String descripcion,String fecha/*, int cant, double valorU, double tot*/) {
        this.id=id;
        this.numreq = numreq;
...
*/
     ...
     */
    public ArrayList <DetalleEgresoProducto> getListaegre() {
        return listaegre;
    }
     ...
     */
    public void setListaegre(ArrayList <DetalleEgresoProducto> listaegre) {
        this.listaegre = listaegre;
    }
